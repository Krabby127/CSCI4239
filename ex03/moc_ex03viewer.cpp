...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Ex03viewer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 30, 2)
    ...
    "Ex03viewer\0reset\0\0lmove\0izoom\0iz\0"
};
...
const QMetaObject Ex03viewer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Ex03viewer.data,
      qt_meta_data_Ex03viewer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Ex03viewer.stringdata))
